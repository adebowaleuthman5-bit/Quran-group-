...
export function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-sage-50">
      <div className="fixed inset-x-0 top-0 z-40 flex h-14 items-center justify-between border-b border-sage-100 bg-surface px-4 lg:hidden">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-30 w-64 transform border-r border-sage-100 bg-surface pt-14 transition-transform lg:static lg:translate-x-0 lg:pt-0 ${
          open ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="hidden items-center justify-between gap-2 border-b border-sage-100 px-5 py-5 lg:flex">
